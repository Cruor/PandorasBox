...
const placements = Ahorn.PlacementDict(
    "Circular Platform (Pandora's Box)" => Ahorn.EntityPlacement(
        ...
        function(entity::CircularResortPlatform)
            ...
            entity.data["nodes"] = Tuple{Int, Int}[(x, y)]
        end
    )
)
